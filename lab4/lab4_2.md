...
```r
mammals_mass_gestation <- select(mammals, "family", "genus", "species", "mass", "gestation" )
mammals_mass_gestation
```
...
```r
filter(mammals_mass_gestation, family =="Bovidae" & mass >= 450000)
```
