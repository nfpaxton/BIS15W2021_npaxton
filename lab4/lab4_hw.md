...
```
## # A tibble: 41 x 5
##    genus       species      taxon  mean.hra.m2 log10.hra
##    <chr>       <chr>        <fct>        <dbl>     <dbl>
##  1 bitis       schneideri   snakes        200       2.30
##  2 carphopis   viridis      snakes        253       2.40
##  3 thamnophis  butleri      snakes        600       2.78
##  4 carphopis   vermis       snakes        700       2.85
##  5 vipera      latastei     snakes       2400       3.38
##  6 gloydius    shedaoensis  snakes       2614.      3.42
##  7 diadophis   punctatus    snakes       6476       3.81
##  8 agkistrodon piscivorous  snakes      10655       4.03
##  9 oocatochus  rufodorsatus snakes      15400       4.19
## 10 pituophis   catenifer    snakes      17400       4.24
## # … with 31 more rows
```
