...
gapminder_clean %>% 
  ...
  theme(axis.text.x = element_text(hjust = .5), plot.title = element_text(size = rel(1.5), hjust = 0.5)) +
...
gapminder_clean %>% 
  ...
  theme_gray(base_family = "Palatino") +
  scale_color_manual(values = palette) +
  theme(axis.text.x = element_text(hjust = .5), plot.title = element_text(size = rel(1.5), hjust = .5)) +
...
```
```{r}
#having more money does help you live longer!
```
